  ...
  return (
    <div className='container'>
      ...
      <form onSubmit={handleSubmit}>
        <input name='nombre' value={formData.nombre} onChange={handleChange} type='text' placeholder='Nombre...' />
        <input name='email' value={formData.email} onChange={handleChange} type='email' placeholder='Email...' />
        <input name='carrera' value={formData.carrera} onChange={handleChange} type='text' placeholder='Carrera...' />
